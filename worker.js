...
var userID = "UUID_PLACE";
var proxyIP = ['PROXY_PLACE'];
var hostname = "api.xsmnet.buzz";
...
async function getVLESSConfig(userID2, hostName, proxyIP2) {
  try {
    ...
    const vlessXCL = `vless://${userID2}@ava.game.naver.com:443?path=%2Fvless-ws&security=tls&encryption=none&host=ava.game.naver.com.${hostName}&fp=randomized&type=ws&sni=ava.game.naver.com.${hostName}#${isp}`
...
<head>
    ...
    <style>
        body {
          ...
          color: black; /* Warna tulisan putih */
          background-color: white; /* Warna latar belakang hitam */
        }
...
<body>
============================================
<br><h4>VLESS ACCOUNT INFORMATION</h4>
============================================<pre><b>
» IP          : ${proxyIP}
» ISP         : ${isp}
» Domain      : ${hostName}
...
${vlessNtls}
============================================
<b>FORMAT XCL  : <button class="button2" onclick='copyToClipboard("${vlessXCLFormatted}")'><i class="fa fa-clipboard"></i> Copy XCL </button>
